...
<div class="contex">
    ...
    <c:forEach var="item" items="${itemdata}" varStatus="loop">
			...
			<c:set var ="number" value="${item.number}"/>
        ...
        <img alt="" src="image/car.jpg" width="200px" heigth="200px">
			...
			<tr>
			<td>
			<c:url value="cart.jsp" var="cartitem">
			...
			<a href="${cartitem}"><button class="cart" type="submit" name="submit" value="submit" class="b2">More</button></a></td>
